...
<section id="basic-horizontal-layouts">
  <div class="card">
    ...
    <div class="card-body">
      <form class="form-horizontal form" id="main-form" action="{{ route('teachers.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="col-12">
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                ...
                <ul class="list-group" id="list-certificate">
