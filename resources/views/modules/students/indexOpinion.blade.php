  ...
  <div class="card-header border-bottom p-1">
    ...
    <div class="dt-action-buttons text-right">
      <div class="dt-buttons d-inline-flex">
        <a href="{{route('students.createOpinion')}}">
  ...
  <script>
    $(function() {
      $('#users-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('students.dataOpinion') !!}',
        columns: [
          { data: 'name', name: 'name' },
        ...
        columnDefs: [
          {
            ...
            render: function (data, type, row, meta) {
              var urlEdit = '{{ route("students.editOpinionStudent", ":id") }}';
              urlEdit = urlEdit.replace(':id', row.id);
              var urlDel = '{{ route("students.deleteOpinion", ":id") }}';
