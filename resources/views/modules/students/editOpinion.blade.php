...
@section('content')
  ...
  <section id="basic-horizontal-layouts">
    <div class="card">
      ...
      <div class="card-body">
        <form class="form-horizontal form" id="main-form" action="{{ route('students.updateOpinionStudent', $item->id) }}" method="POST" enctype="multipart/form-data">
          @method('PUT')
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="form-group row">
                <div class="col-sm-3 col-form-label font-weight-bold">
                  <label for="opinion_student">{{ config('label.students.opinion_student') }}</label>
                </div>
                <div class="col-sm-9">
                  <textarea class="form-control" name="opinion" id="opinion" placeholder="Nội dung text" id="floatingTextarea2"
                            style="height: 100px"> {{ $item->opinion }}
                          </textarea>
