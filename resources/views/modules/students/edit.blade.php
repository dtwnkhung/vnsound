...
@section('content')
  ...
  <section id="basic-horizontal-layouts">
    <div class="card">
      ...
      <div class="card-body">
        <form class="form-horizontal form" id="main-form" action="{{ route('students.update', $item->id) }}" method="POST" enctype="multipart/form-data">
          @method('PUT')
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="form-group row">
                <div class="col-sm-3 col-form-label font-weight-bold">
                  <label for="color">{{ config('label.teachers.thumbnail') }}<span class="text-danger">*</span></label>
                </div>
                <div class="col-sm-9">
