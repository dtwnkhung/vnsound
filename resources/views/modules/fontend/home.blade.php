                    ...
                    <div class="swiper-container artists_slide">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <a href="{{ route('home.artistDetail', ['id' => $artist['id']]) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="course_content_left">
                                            ...
                                            <div class="course_content_txt">
                                                {{ $pro['description'] }}
                                            </div>
                                            <a href="{{ route('home.products', ['id' => $pro['id']]) }}"
                                                class="btn btn-main">
                                                Tìm hiểu thêm
                                            </a>
                                        </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="sponcor_slide_item">
                                    <img src="{{ URL::to('/images/partners'). '/'. $item['images']}}"
                                ...
                                <div class="swiper-slide">
                                    <div class="knowledge_item">
                                        ...
                                        <div class="knowledge_item_body">
                                            ...
                                            <a href="{{ route("home.news", ["slug" => $item['slug']]) }}"
                                                class="knowledge_item_title">
                                                {{ $item->title }}
                                            </a>
                                            <a class="knowledge_item_links"
                                                href="{{ route("home.news", ["slug" => $item['slug']]) }}">
                                                Xem thêm
                                            </a>
                                        </div>
                                    </div>
