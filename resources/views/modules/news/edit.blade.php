...
@section('content')
  ...
  <section id="basic-horizontal-layouts">
    <div class="card">
      ...
      <div class="card-body">
        <form class="form-horizontal form" id="main-form" action="{{ route('news.update', $item->id) }}" method="POST" enctype="multipart/form-data">
          @method('PUT')
                ...
                <div class="col-sm-9">
                  ...
                  <div class="row" id="images">
                    @foreach ($item->images as $img)
                      <div class="col-4">
                        <img src="{{ URL::to('/images/news'). '/600x400-' .$img }} " alt="" width="100%">
                      </div>
                    @endforeach
                  </div>
                ...
                <div class="col-sm-9">
                  <select class="select2 form-control form-control-lg is-invalid" name="type" id="type">
                    ...
                    @elseif($item->type == 2)
                      ...
                      <option value="2" selected>Kiến thức</option>
                      <option value="3">Tin nổi bật</option>
                      <option value="4">Kiến thức nổi bật</option>
                    @elseif($item->type == 3)
                      <option value="1">Tin tức</option>
                      <option value="2">Kiến thức</option>
                      <option value="3" selected>Tin nổi bật</option>
                      <option value="4">Kiến thức nổi bật</option>
                    @elseif($item->type == 4)
                      <option value="1">Tin tức</option>
                      <option value="2">Kiến thức</option>
                      <option value="3">Tin nổi bật</option>
                      <option value="4" selected>Kiến thức nổi bật</option>
                    @else 
                      <option value="1">Tin tức</option>
                      <option value="2">Kiến thức</option>
                      <option value="3">Tin nổi bật</option>
