...
@section('content')
  ...
  <section id="basic-horizontal-layouts">
    <div class="card">
      ...
      <div class="card-body">
        <form class="form-horizontal form" id="main-form" action="{{ route('otherNews.update', $item->id) }}" method="POST" enctype="multipart/form-data">
          @method('PUT')
                ...
                <div class="col-sm-9">
                  ...
                  <div class="row" id="images">
                    @foreach ($item->images as $img)
                      <div class="col-4">
                        <img src="{{ URL::to('/images/otherNews'). '/600x400-' .$img }} " alt="" width="100%">
                      </div>
                    @endforeach
                  </div>
  ...
  <script>
    $(document).ready(function(){
      ...
      function uploadFile(file) {
        ...
        $.ajax({
          url: "{{ route('otherNews.handlerImage') }}",
          type:'POST',
          data: formData,
          processData: false,
          contentType: false,
