...
@section('content')
    ...
    <section id="basic-horizontal-layouts">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal form" id="main-form" action="{{ route('products.store') }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                <div class="col-sm-3 col-form-label font-weight-bold">
                                    <label for="color">{{ config('label.products.images') }} <span
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <input type="number" id="free_price" name="free_price" class="form-control"
