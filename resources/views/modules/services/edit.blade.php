...
@section('content')
  ...
  <section id="basic-horizontal-layouts">
    <div class="card">
      ...
      <div class="card-body">
        <form class="form-horizontal form" id="main-form" action="{{ route('services.update', $item->id) }}" method="POST" enctype="multipart/form-data">
          @method('PUT')
                ...
                <div class="col-sm-9">
                  ...
                  <div class="row" id="thumbnails">
                    @foreach ($item->thumbnail as $img)
                      <div class="col-4">
                        <img src="{{ URL::to('/images/services'). '/' .$img }} " alt="" width="100%">
                      </div>
                    @endforeach
                  </div>
