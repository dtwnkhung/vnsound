                ...
                <form class="form-horizontal form" id="main-form" action="{{ route('artists.store') }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group row">
                                <div class="col-sm-3 col-form-label font-weight-bold">
                                    <label for="name">{{ config('label.artists.name') }}<span
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                <div class="col-sm-3 col-form-label font-weight-bold">
                                    <label for="color">{{ config('label.artists.banner') }}<span
                                            class="text-danger">*</span></label>
                                </div>
                                <div class="col-sm-9">
                                    ...
                                    <input type="file" id="banner" class="form-control hidden" name="banner[]"
                                        accept="image/*" />
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="file" id="partners" class="form-control hidden" name="partners[]"
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                <div class="col-sm-3 col-form-label font-weight-bold">
                                    <label for="color">{{ config('label.artists.clubs') }} <span
                                            class="text-danger font-italic d-block w-100">Kích thước ảnh 500 x 500
                                        </span></label>
                                </div>
                                <div class="col-sm-9">
                                    ...
                                    <input type="file" id="clubs" class="form-control hidden" name="clubs[]"
                                        multiple accept="image/*" />
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="project_1_title" class="form-control"
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                <div class="col-sm-3 col-form-label font-weight-bold">
                                    <label for="color">{{ config('label.artists.project_1_image') }} <span
                                            class="text-danger">*</span> <span
                                            class="text-danger font-italic d-block w-100">Kích thước ảnh 500 x
                                            500</span></label>
                                </div>
                                <div class="col-sm-9">
                                    ...
                                    <input type="file" id="project_1_image" class="form-control hidden"
                                        name="project_1_image[]" accept="image/*" />
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                <div class="col-sm-3 col-form-label font-weight-bold">
                                    <label for="color">{{ config('label.artists.project_1_text') }}<span
                                            class="text-danger">*</span></label>
                                </div>
                                <div class="col-sm-9">
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="project_2_title" class="form-control"
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                <div class="col-sm-3 col-form-label font-weight-bold">
                                    <label for="color">{{ config('label.artists.project_2_image') }} <span
                                            class="text-danger">*</span> <span
                                            class="text-danger font-italic d-block w-100">Kích thước ảnh 500 x
                                            500</span></label>
                                </div>
                                <div class="col-sm-9">
                                    ...
                                    <input type="file" id="project_2_image" class="form-control hidden"
                                        name="project_2_image[]" accept="image/*" />
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                <div class="col-sm-3 col-form-label font-weight-bold">
                                    <label for="color">{{ config('label.artists.project_2_text') }}<span
                                            class="text-danger">*</span></label>
                                </div>
                                <div class="col-sm-9">
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                <div class="col-sm-3 col-form-label font-weight-bold">
                                    <label for="bts_text">{{ config('label.artists.bts_text') }}<span
                                            class="text-danger">*</span></label>
                                </div>
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="bts_link_fb" class="form-control"
                                            name="bts_link_fb" />
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="bts_link_ins" class="form-control"
                                            name="bts_link_ins" />
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="bts_link_tt" class="form-control"
                                            name="bts_link_tt" />
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="bts_link_yt" class="form-control"
                                            name="bts_link_yt" />
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="bts_link_sc" class="form-control"
                                            name="bts_link_sc" />
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                <div class="col-sm-3 col-form-label font-weight-bold">
                                    <label for="color">{{ config('label.artists.bts_image') }} <span
                                            class="text-danger">*</span> <span
                                            class="text-danger font-italic d-block w-100">Kích thước ảnh 500 x
                                            500</span></label>
                                </div>
                                <div class="col-sm-9">
                                    ...
                                    <input type="file" id="bts_image" class="form-control hidden" name="bts_image[]"
                                        accept="image/*" />
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="file" id="life_style_1" class="form-control hidden"
                                        name="life_style_1[]" accept="image/*" />
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="file" id="life_style_2" class="form-control hidden"
                                        name="life_style_2[]" accept="image/*" />
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="file" id="life_style_3" class="form-control hidden"
                                        name="life_style_3[]" accept="image/*" />
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="file" id="life_style_4" class="form-control hidden"
                                        name="life_style_4[]" accept="image/*" />
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="file" id="life_style_5" class="form-control hidden"
                                        name="life_style_5[]" accept="image/*" />
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="file" id="life_style_6" class="form-control hidden"
                                        name="life_style_6[]" accept="image/*" />
