...
<section id="basic-horizontal-layouts">
  <div class="card">
    ...
    <div class="card-body">
      <form class="form-horizontal form" id="main-form" action="{{ route('artists.update', $item->id) }}" method="POST"
      ...
      <div class="col-sm-9">
        ...
        <div class="row" id="partners">
          ...
          <div class="col-sm-12 col-md-4 col-lg-3">
            ...
            <button type="button" data-id="{{$key}}" data-partner_id="{{$item->id}}"
              class="delete_image_partners btn-del-image d-flex align-items-center justify-content-center">
      ...
      <div class="col-sm-9">
        ...
        <div class="row" id="clubs">
          ...
          <div class="col-sm-12 col-md-4 col-lg-3">
            ...
            <button type="button" data-id="{{$key}}" data-club_id="{{$item->id}}"
              class="btn-del-image d-flex align-items-center justify-content-center">
              <svg viewPort="0 0 12 12" version="1.1" xmlns="http://www.w3.org/2000/svg">
                <line x1="1" y1="11" x2="11" y2="1" stroke="black" stroke-width="2" />
                <line x1="1" y1="1" x2="11" y2="11" stroke="black" stroke-width="2" />
              </svg>
            ...
            <button type="button" data-id="{{$key}}" data-club_id="{{$item->id}}"
              class="delete_image_clubs btn-del-image d-flex align-items-center justify-content-center">
              <svg viewPort="0 0 12 12" version="1.1" xmlns="http://www.w3.org/2000/svg">
                <line x1="1" y1="11" x2="11" y2="1" stroke="black" stroke-width="2" />
                <line x1="1" y1="1" x2="11" y2="11" stroke="black" stroke-width="2" />
              </svg>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-4 col-lg-3">
            <img src="{{ URL::to('/images/artists'). '/' .$img }} " alt="" width="100%">
            <button type="button" data-id="{{$key}}" data-project_1_image="{{$item->id}}"
              class="delete_project_1_image btn-del-image d-flex align-items-center justify-content-center">
              <svg viewPort="0 0 12 12" version="1.1" xmlns="http://www.w3.org/2000/svg">
                <line x1="1" y1="11" x2="11" y2="1" stroke="black" stroke-width="2" />
                <line x1="1" y1="1" x2="11" y2="11" stroke="black" stroke-width="2" />
              </svg>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <textarea class="form-control" name="project_1_text" id="project_1_text" placeholder="Nội dung text"
          id="floatingTextarea2" style="height: 100px">{{ $item->project_1_text }}</textarea>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        ...
        <div class="row" id="project_2_image">
          ...
          <div class="col-sm-12 col-md-4 col-lg-3">
            <img src="{{ URL::to('/images/artists'). '/' .$img }} " alt="" width="100%">
            <button type="button" data-id="{{$key}}" data-project_2_image="{{$item->id}}"
              class="delete_project_2_image btn-del-image d-flex align-items-center justify-content-center">
              <svg viewPort="0 0 12 12" version="1.1" xmlns="http://www.w3.org/2000/svg">
                <line x1="1" y1="11" x2="11" y2="1" stroke="black" stroke-width="2" />
                <line x1="1" y1="1" x2="11" y2="11" stroke="black" stroke-width="2" />
              </svg>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <textarea class="form-control" name="project_2_text" id="project_2_text" placeholder="Nội dung text"
          id="floatingTextarea2" style="height: 100px">{{ $item->project_2_text }}</textarea>
  ...
  <div class="col-12">
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <div class="input-group input-group-merge">
          <input type="text" id="bts_text" class="form-control" name="bts_text" value="{{ $item->bts_text }}" />
        </div>
  ...
  <div class="toast toast-basic hide position-fixed toast-delete" role="alert" aria-live="assertive" aria-atomic="true"
