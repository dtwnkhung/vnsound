...
@section('content')
  ...
  <section id="basic-horizontal-layouts">
    <div class="card">
      ...
      <div class="card-body">
        <form class="form-horizontal form" id="main-form" action="{{ route('events.update', $item->id) }}" method="POST" enctype="multipart/form-data">
          @method('PUT')
            ...
            <div class="col-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  ...
                  @if ($errors->has('order'))
                    <script>
                      document.getElementById("order").classList.add("is-invalid");
                    </script>
                    <div class="invalid-feedback" style="display: block;">{{ $errors->first('order') }}</div>
                  @endif
                </div>
              </div>
            </div>
                ...
                <div class="col-sm-9">
                  ...
                  <div class="row" id="thumbnails">
                    @foreach ($item->thumbnail as $img)
                      <div class="col-4">
                        <img src="{{ URL::to('/images/events'). '/' .$img }} " alt="" width="100%">
                      </div>
                    @endforeach
                  </div>
            ...
            <div class="col-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  ...
                  <input type="file" id="images" class="form-control hidden" name="images[]" multiple/>
                  @if($item->images)
                    <div class="row" id="images">
                      @foreach($item->images as $comment)
                        <div class="col-2">
                          <img src="{{ URL::to('/images/events'). '/' .$comment }} " alt="" width="100%">
                        </div>
                      @endforeach
                    </div>
                  @endif
