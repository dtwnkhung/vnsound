  ...
  <div class="auth-inner py-2">
    ...
    <div class="card mb-0">
      <div class="card-body">
        ...
        <h4 class="card-title mb-1">Thay đổi mật khẩu 🔒</h4>
        ...
        <form class="auth-reset-password-form mt-2" method="POST" action="{{ route('password.update') }}">
          ...
          <div class="form-group">
            <div class="d-flex justify-content-between">
              <label for="reset-password-new">Mật khẩu cũ</label>
            </div>
            <div class="input-group input-group-merge form-password-toggle @error('oldPassword') is-invalid @enderror">
              <input type="password" class="form-control form-control-merge @error('oldPassword') is-invalid @enderror" id="reset-password-old" name="oldPassword" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="reset-password-old" tabindex="2" autofocus />
          ...
          <div class="form-group">
            <div class="d-flex justify-content-between">
              <label for="reset-password-new">Mật khẩu mới</label>
            </div>
          ...
          <div class="form-group">
            <div class="d-flex justify-content-between">
              <label for="reset-password-confirm">Nhập lại mật khẩu</label>
            </div>
          ...
          <button id="submitForm" type="submit" class="btn btn-primary btn-block" tabindex="4">Lưu thay đổi</button>
        </form>
